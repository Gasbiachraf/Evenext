    ...
    <div class=" ">
        ...
        <div class="w-full h-[1100px] md:h-[60vh] lg:h-[80vh] bg-blue-300 relative">
            ...
            <div
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-8 py-6 px-4 md:py-12 md:px-8 text-sm">
                            ...
                            <div class="flex flex-col gap-1">
                                ...
                                <input class="border-[1px] border-white bg-gray-800 p-2 rounded-md"
                                    placeholder="Enter Your Name" required name="name" type="text" />
                            </div>
                            ...
                            <div class="flex flex-col gap-1">
                                ...
                                <input class="border-[1px] border-white bg-gray-800 p-2 rounded-md"
                                    placeholder="Enter Your Email" required name="email" type="email" />
                            </div>
                            ...
                            <div class="flex flex-col gap-1">
                                ...
                                <input class="border-[1px] border-white bg-gray-800 p-2 rounded-md"
                                    placeholder="Enter Your Phone Number" required name="phone" type="tel" />
                            </div>
                ...
                <!-- {/* right div  */} -->
                <div class="py-6 px-4 h-[fit-content] md:h-full bg-blue-800  flex flex-col  gap-y-20 justify-center">
                    <div>
                        <!-- {/* heading tag  */} -->
                        ...
                        <div class="row-span-4 flex flex-col items-center ">
                            <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-mail-share"
                    ...
                    <div class="flex justify-center  items-center gap-4 ">
                        ...
                        <a title="github" href="#">
                            <img class="h-8 w-8 invert"
                                src="https://www.svgrepo.com/show/512317/github-142.svg" /></a>
                    </div>
                    </div>
                </div>
            </div>
